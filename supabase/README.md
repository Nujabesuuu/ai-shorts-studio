...
| `seed.sql` | синтетичні демо-дані: 2 ніші, повний ланцюг Day 1–4, три прогони «до/після» |
...
Демо-відео лежить у `ai-shorts-admin/public/demo/demo-reel.mp4`, тож Storage не потрібен.
